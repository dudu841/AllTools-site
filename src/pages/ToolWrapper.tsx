...
const toolComponents: Record<ToolId, React.FC> = {
  ...
  "social-resizer": PlaceholderTool,
  "meme-generator": PlaceholderTool,
  "banner-thumbnail-creator": PlaceholderTool,
  "bmi-calculator": PlaceholderTool,
  "calorie-calculator": PlaceholderTool,
  "mortgage-calculator": PlaceholderTool,
  "net-gross-salary": PlaceholderTool,
  "discount-margin-markup": PlaceholderTool,
  "travel-time-calculator": PlaceholderTool,
  "apr-monthly-converter": PlaceholderTool,
  "stock-simulator": PlaceholderTool,
  "investment-simulator": PlaceholderTool,
  "word-counter": PlaceholderTool,
  "text-case-converter": PlaceholderTool,
  "password-strength-checker": PlaceholderTool,
  "encrypt-decrypt": PlaceholderTool,
  "base-converter": PlaceholderTool,
  "scientific-calculator": PlaceholderTool,
  "currency-converter": PlaceholderTool,
  "cm-inch-converter": PlaceholderTool,
  "kg-lbs-converter": PlaceholderTool,
  "sqm-sqft-converter": PlaceholderTool,
  "backlink-counter": PlaceholderTool,
  "rank-checker": PlaceholderTool,
  "meta-tags-checker": PlaceholderTool,
  "html-css-validator": PlaceholderTool,
  "site-speed-checker": PlaceholderTool,
};
